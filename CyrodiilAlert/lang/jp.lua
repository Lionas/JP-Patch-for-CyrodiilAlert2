...
-- OnDeposeEmperor
ZO_CreateStringId("SI_CYRODIIL_ALERT_EMPEROR", "皇帝 ")
ZO_CreateStringId("SI_CYRODIIL_ALERT_ABDICATED", " が退位しました！")
ZO_CreateStringId("SI_CYRODIIL_ALERT_DEPOSED", " が宣誓しました！")
